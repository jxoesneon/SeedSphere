...
void main() {
  group('ResourceManagerImpl', () {
    ...
    test('openStream, setProtocol, and release scopes', () async {
      ...
      final streamScope = await resourceManager.openStream(
        peerA,
        Direction.outbound,
      );
    ...
    group('with restrictive limits', () {
      ...
      test(
        'exceeding connection limit throws ResourceLimitExceededException',
        () async {
      ...
      test(
        ...
        () async {
          ...
          final streamScope1 = await limitedResourceManager.openStream(
            peerA,
            Direction.outbound,
          );
      ...
      test('streams to different peers respect individual peer limits', () async {
        ...
        final streamScopeA = await limitedResourceManager.openStream(
          peerA,
          Direction.outbound,
        );
        ...
        final streamScopeB = await limitedResourceManager.openStream(
          peerB,
          Direction.outbound,
        );
