...
class DialResponse_ResponseStatus extends $pb.ProtobufEnum {
  ...
  const DialResponse_ResponseStatus._($core.int v, $core.String n)
      : super(v, n);
}
...
class DialBackResponse_DialBackStatus extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, DialBackResponse_DialBackStatus> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static DialBackResponse_DialBackStatus? valueOf($core.int value) =>
      _byValue[value];

  const DialBackResponse_DialBackStatus._($core.int v, $core.String n)
      : super(v, n);
}
