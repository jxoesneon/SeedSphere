...
class TrackerService {
  ...
  /// Variant URLs for tracker lists.
  ...
  String? _cachedVariant;
  DateTime? _lastFetchTime;

  /// Returns the optimized list of trackers.
  Future<List<String>> getTrackers(AppConfig config) async {
    ...
    return await _fetchTrackers(targetUrl, cacheKey, config);
  }

  Future<List<String>> _fetchTrackers(
    String url,
    String cacheKey,
    AppConfig config,
  ) async {
