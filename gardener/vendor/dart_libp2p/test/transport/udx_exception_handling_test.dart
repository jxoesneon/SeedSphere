...
void main() {
  group('UDX Exception Handling', () {
    ...
    test('UDXExceptionUtils.safeClose should not throw on error', () async {
      ...
      await UDXExceptionUtils.safeClose(() async {
        closeCalled = true;
    ...
    test(
      'UDXExceptionUtils.withTimeout should wrap TimeoutException',
      () async {
        expect(
    ...
    test(
      'UDXRetryConfig.bootstrapServer should have more aggressive settings',
      () {
