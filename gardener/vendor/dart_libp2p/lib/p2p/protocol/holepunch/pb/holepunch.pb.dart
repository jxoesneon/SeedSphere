...
class HolePunch extends $pb.GeneratedMessage {
  ...
  HolePunch._() : super();
  factory HolePunch.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory HolePunch.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<HolePunch_Type>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.QE,
        defaultOrMaker: HolePunch_Type.CONNECT,
        valueOf: HolePunch_Type.valueOf,
        enumValues: HolePunch_Type.values)
