  ...
  group('TCPTransport Raw Connection Tests', () {
    ...
    test(
      ...
      () async {
        ...
        while (totalBytesRead < dataToSend.length) {
          ...
          final bytesToCopy = min(
            chunk.length,
            dataToSend.length - totalBytesRead,
          );
    ...
    group('Yamux over TCP Tests', () {
      ...
      setUp(() async {
        ...
        final clientDialFuture = yamuxClientTransport.dial(
          yamuxActualListenAddr,
        );
        ...
        serverYamuxSession = YamuxSession(
          serverTcpConnForYamux!,
          multiplexerConfig,
          false,
        );
