...
// in router/test/distributed_scraper_service_coverage_test.dart.
...
import 'package:router/event_service.dart' as _i6;
import 'package:router/tracker_service.dart' as _i8;
import 'package:seedsphere_core/src/core/app_config.dart' as _i9;
import 'package:shelf/shelf.dart' as _i3;
...
class MockEventService extends _i1.Mock implements _i6.EventService {
  @override
  _i7.Stream<String> subscribe(String? gardenerId) =>
      (super.noSuchMethod(
            Invocation.method(#subscribe, [gardenerId]),
  ...
  bool isConnected(String? clientId) =>
      (super.noSuchMethod(
            Invocation.method(#isConnected, [clientId]),
            returnValue: false,
            returnValueForMissingStub: false,
          )
          as bool);
  ...
  List<String> getConnectedClients() =>
      (super.noSuchMethod(
            Invocation.method(#getConnectedClients, []),
            returnValue: <String>[],
            returnValueForMissingStub: <String>[],
          )
          as List<String>);
  ...
  void publish(String? gardenerId, String? event, Map<String, dynamic>? data) =>
      super.noSuchMethod(
        Invocation.method(#publish, [gardenerId, event, data]),
        returnValueForMissingStub: null,
      );

  @override
  _i3.Response sseResponse(_i7.Stream<String>? stream) =>
      (super.noSuchMethod(
            Invocation.method(#sseResponse, [stream]),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTrackerService extends _i1.Mock implements _i8.TrackerService {
  @override
  ...
  @override
  _i7.Future<void> refreshMasterList() =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<Map<String, dynamic>> optimize(List<String>? incoming) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Stream<Map<String, dynamic>> sweep(String? sourceUrl) =>
      (super.noSuchMethod(
            Invocation.method(#sweep, [sourceUrl]),
            returnValue: _i7.Stream<Map<String, dynamic>>.empty(),
            returnValueForMissingStub: _i7.Stream<Map<String, dynamic>>.empty(),
          )
...
class MockAppConfig extends _i1.Mock implements _i9.AppConfig {
  ...
  bool get enableTorznab =>
      (super.noSuchMethod(
            Invocation.getter(#enableTorznab),
            returnValue: false,
            returnValueForMissingStub: false,
          )
          as bool);
  ...
  bool get probeTrackers =>
      (super.noSuchMethod(
            Invocation.getter(#probeTrackers),
            returnValue: false,
            returnValueForMissingStub: false,
          )
          as bool);
  ...
  int get probeTimeoutMs =>
      (super.noSuchMethod(
            Invocation.getter(#probeTimeoutMs),
            returnValue: 0,
            returnValueForMissingStub: 0,
          )
          as int);
  ...
  @override
  _i7.Future<String?> getTorznabKey() =>
      (super.noSuchMethod(
