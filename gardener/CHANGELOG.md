...
- **Fixed:** Corrected `TitleVerifier` fuzzy matching threshold to strictly reject sequels without years (e.g., "Iron Man" vs "Iron Man 2").
- **Fixed:** Added region codes (US, UK) to safe patterns for Series verification.

## [2.1.3] - 2026-01-13

- **Fixed:** Added missing API documentation to `RateLimiter` to satisfy strict CI analysis rules.
